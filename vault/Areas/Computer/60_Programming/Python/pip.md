---
created: 2025-10-30T03:42
modified: 2026-01-10T19:38
url:
  - https://pip.pypa.io/
---
...
General Options:
  ...
  --keyring-provider <keyring_provider>
                              Enable the credential lookup via the keyring library if
                              user input is allowed. Specify which mechanism to use
                              [auto, disabled, import, subprocess]. (default: auto)
  ...
  --resume-retries <resume_retries>
                              Maximum attempts to resume or restart an incomplete
                              download. (default: 5)
```

pip install 的路径:  
可通过`python -m site` 以及 `pip -V`或`pip list -v`查看.

- 系统环境
    - homebrew: `/opt/homebrew/lib/python3.14/site-packages`
    - USER_SITE: `/Users/mac/Library/Python/3.14/site-packages`
- conda
    - envs: `${CONDA_PREFIX}/lib/python3.14/site-packages`
    - USER_SITE: `~/.local/lib/python3.14/site-packages`
- 虚环境