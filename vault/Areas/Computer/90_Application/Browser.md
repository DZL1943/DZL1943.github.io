...
- 桌面端
    - Chrome 系
        ...
        - [x] [Edge](https://www.microsoft.com/zh-cn/edge): 备用
        - [ ] Arc: 中止
        - [ ] Opera
        - [ ] Vivaldi
        - [ ] ~~Brave: 夹带私货~~
...
- 移动端
    ...
    - Android
        ...
        - [ ] Firefox Nightly: 支持插件(普通版也支持了)
        - [x] [Iceraven](https://github.com/fork-maintainers/iceraven-browser): 基于 Firefox
        - [ ] ~~Fennec: 基于 Firefox 增强~~
        - [ ] ~~Mull: Fennec + Arkenfox~~